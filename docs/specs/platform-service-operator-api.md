...
- `docs/specs/platform-service-match-request-scheduling.md`: match request / scheduling の正本
...
- `POST /api/v1/match-requests`
  - 目的:
    1 件の `match request` を validation し、minimal scheduling policy で queue へ流す
