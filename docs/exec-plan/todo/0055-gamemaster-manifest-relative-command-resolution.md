...
- follows: `docs/exec-plan/done/0052-external-gamemaster-manifest-registration-01-dev-runner-overlay.md`
...
- relative path を absolute 化することで既存 test expectation が崩れる
  - mitigation: spec wordingとtest expectationを同じ change set で揃える
