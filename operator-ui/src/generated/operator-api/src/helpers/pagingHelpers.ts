 ...
 */
interface PagedResult<TElement, TPageResponse, TPageSettings> {
  /**
  ...
  getPage: (
    ...
    { pagedResponse: TPageResponse; nextToken?: string } | undefined
  >;
  /**
 ...
 */
export function buildPagedAsyncIterator<TElement, TPageResponse, TPageSettings>(
